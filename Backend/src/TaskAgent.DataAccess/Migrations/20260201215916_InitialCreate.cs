        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibleToUserIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SprintDurationDays = table.Column<int>(type: "int", nullable: false),
                    VisibleColumnsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TaskSizeUnit = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
