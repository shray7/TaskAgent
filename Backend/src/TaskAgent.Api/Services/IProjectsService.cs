...
{
    Task<IEnumerable<ProjectDto>> GetAllAsync(int currentUserId, CancellationToken ct = default);
    Task<ProjectDto?> GetByIdAsync(int id, int currentUserId, CancellationToken ct = default);
